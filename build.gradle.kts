...
tasks.register<Exec>("gatlingRunCi") {
    ...
    commandLine(wrapper, "gatlingRun", "--all", "-getPrisonNumber=$getPrisonNumber", "-getCrnNumber=$getCrnNumber", "-getDefendantId=$getDefendantId", "-Denv=$env", "-Dduration=$duration")
}
gatling {
